...
def _generate_config(file_data, io_settings: dict = {"output_path": "output/"}) -> bool:
    ...
    try:
        ...
        print(f"Error while loading default settings: {e}")
        return False
    return True

def main():
    print(f"Conversion from Python dictionary to ini config file {"successful!" if _generate_config(user_input) else "failed..."}")
